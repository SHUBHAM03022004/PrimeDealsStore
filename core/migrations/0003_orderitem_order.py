# Generated by Django 5.2 on 2025-04-12 10:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_id', models.CharField(blank=True, default=None, max_length=200, null=True, unique=True)),
                ('datetime_ofpayment', models.DateTimeField(auto_now_add=True)),
                ('order_delivered', models.BooleanField(default=False)),
                ('order_recieived', models.BooleanField(default=False)),
